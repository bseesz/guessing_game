...
words = "pizza", "fairy", "python", "sharp", "teeth", "otter",  "tea", "book", "power", "walk", "love"

secret_word = random.choice(words)

#loop to account for words of varying length
clue = []
index = 0
...
difficulty = input("Choose difficulty (level 1, 2, or 3):\n 1 Easy\n 2 Normal\n 3 Hard \n")
